...
2. Sebor_04A_Biopython_Tutorial_LSH-1.ipynb - uses KRAS.fasta, KRAS_genbank.gb, and opuntia.dnd
>Practice using Biopython methods, manipulating fasta, genbank, and phylogeny files.
3. Person_ans.py and Sebor_wizard_class_HW.py
...
4. PandasScipy jupyter notebook - uses hist_taxa_treat2.txt
